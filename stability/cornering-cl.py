...
def eig_wobble(eigenvalue, phi_0):
    ...
    if phi_0 == 0:
        ...
        for i in eigenvalue:
            if i.imag > 50 and i.imag <= 70 and i.real > -35 and i.real < 15:
                wobble.append(i)
    elif phi_0 == np.radians(60):
        for i in eigenvalue:
            if i.imag > 70 and i.imag <= 85 and i.real > -40 and i.real < 0:
                wobble.append(i)
...
for phi_0 in phi00:
    ...
    black_tri = mlines.Line2D([], [], color = 'black', marker = 's', \
                            linestyle = 'None', markersize = 10, fillstyle = 'none', label = r'$C_L = 0.0$')
    blue_circle = mlines.Line2D([], [], color = 'black', marker = 'o', \
                                linestyle = 'None', markersize = 10, fillstyle = 'none', \
                                    label = r'$C_L = 1.0, \; D = 0.06125 V_x^2$')
    red_triangle = mlines.Line2D([], [], color = 'black', marker = '^', \
                                linestyle = 'None', markersize = 10, fillstyle = 'none', \
                                    label = r'$C_L = 2.0, \; D = 0.1225 V_x^2$')


    ax.legend(handles = [black_tri, blue_circle, red_triangle], loc = 'lower left', fontsize = 15)
    ...
    # ax.text(5, 35, r'\textbf{Unstable}', size=15)
    ...
    #     ax.text(-12, 12, r'\textit{weave}', size=15)
    ...
    # ax.set_title(r'$C_L = 0.0: D = 0; \qquad C_L = 1.0: D = 1.2541 V_x^2; \qquad C_L = 2.0: D = 2.5082 V_x^2$', size=15)

    plt.tick_params(labelsize=15)
    plt.grid()
    # if phi_0 == 0:
    #     plt.savefig('RL-phi0-CL.pdf')
    # elif phi_0 == np.radians(30):
    #     plt.savefig('RL-phi30-CL.pdf')
    # elif phi_0 == np.radians(60):
    #     plt.savefig('RL-phi60-CL.pdf')
    plt.show()
...
ax2.plot(vx0_0, weave_supremo[0][0], color = 'k', linestyle = 'solid', marker = 's', fillstyle = 'none', markersize = 10, markevery = [-1])#, marker = '1', markersize = 12)
ax2.plot(vx1_0, weave_supremo[0][1], color = 'k', linestyle = 'solid', marker = 'o', fillstyle = 'none', markersize = 10, markevery = [-1])
ax2.plot(vx2_0, weave_supremo[0][2], color = 'k', linestyle = 'solid', marker = '^', fillstyle = 'none', markersize = 10, markevery = [-1])

ax2.plot(vx0_1, weave_supremo[1][0], color = 'k', linestyle = 'dashed', marker = 's', fillstyle = 'none', markersize = 10, markevery = [114])#, marker = 's', fillstyle = 'none', markersize = 10, markevery = [0, -1])
ax2.plot(vx1_1, weave_supremo[1][1], color = 'k', linestyle = 'dashed', marker = 'o', fillstyle = 'none', markersize = 10, markevery = [108])
ax2.plot(vx2_1, weave_supremo[1][2], color = 'k', linestyle = 'dashed', marker = '^', fillstyle = 'none', markersize = 10, markevery = [109])

ax2.plot(vx0_2, weave_supremo[2][0], color = 'k', linestyle = 'dotted', label = r'$C_L = 0.0$', marker = 's', fillstyle = 'none', markersize = 10, markevery = [28])#, marker = 'o', fillstyle = 'none', markersize = 10, markevery = [0, -1])
ax2.plot(vx1_2, weave_supremo[2][1], color = 'k', linestyle = 'dotted', label = r'$C_L = 1.0$', marker = 'o', fillstyle = 'none', markersize = 10, markevery = [28])
ax2.plot(vx2_2, weave_supremo[2][2], color = 'k', linestyle = 'dotted', label = r'$C_L = 2.0$', marker = '^', fillstyle = 'none', markersize = 10, markevery = [28])
...
weave_legendElements = [Line2D([0], [0], color = 'k', linestyle = 'solid',  label = r'$\varphi_0 = 0^{\circ}$'),
                        ...
                        Line2D([0], [0], color = 'k', fillstyle = 'none', marker = 's', label = r'$C_L = 0.0$', linestyle = 'none', markersize = 10),
                        Line2D([0], [0], color = 'k', fillstyle = 'none', marker = 'o', label = r'$C_L = 1.0, \; D = 0.06125 V_x^2$', linestyle = 'none', markersize = 10),
                        Line2D([0], [0], color = 'k', fillstyle = 'none', marker = '^', label = r'$C_L = 2.0, \; D = 0.1225 V_x^2$', linestyle = 'none', markersize = 10)]
...
ax3.plot(vx0_3, wobble_supremo[0][0], color = 'k', linestyle = 'solid', marker = 's', fillstyle = 'none', markersize = 10, markevery = [-1])
ax3.plot(vx1_3, wobble_supremo[0][1], color = 'k', linestyle = 'solid', marker = 'o', fillstyle = 'none', markersize = 10, markevery = [-1])
ax3.plot(vx2_3, wobble_supremo[0][2], color = 'k', linestyle = 'solid', marker = '^', fillstyle = 'none', markersize = 10, markevery = [-1])

ax3.plot(vx0_4, wobble_supremo[1][0], color = 'k', linestyle = 'dashed', marker = 's', fillstyle = 'none', markersize = 12, markevery = [65])
ax3.plot(vx1_4, wobble_supremo[1][1], color = 'k', linestyle = 'dashed', marker = 'o', fillstyle = 'none', markersize = 12, markevery = [70])
ax3.plot(vx2_4, wobble_supremo[1][2], color = 'k', linestyle = 'dashed', marker = '^', fillstyle = 'none', markersize = 12, markevery = [75])

ax3.plot(vx0_5, wobble_supremo[2][0], color = 'k', linestyle = 'dotted', label = r'$C_L = 0.0$', marker = 's', fillstyle = 'none', markersize = 10, markevery = [26])
ax3.plot(vx1_5, wobble_supremo[2][1], color = 'k', linestyle = 'dotted', label = r'$C_L = 1.0$', marker = 'o', fillstyle = 'none', markersize = 10, markevery = [30])
ax3.plot(vx2_5, wobble_supremo[2][2], color = 'k', linestyle = 'dotted', label = r'$C_L = 2.0$', marker = '^', fillstyle = 'none', markersize = 10, markevery = [33])
...
plt.hlines(0, 0, 105, colors='k', linestyles='solid')
# plt.legend(loc = 'lower right', fontsize = '15')
plt.legend(handles = weave_legendElements, loc = 'upper right', fontsize = 15)
plt.xlim([0, 105])
plt.ylim([-40, 16])

xx1, xx2, yy1, yy2 = 37, 44, -17, -12.5
axins1 = ax3.inset_axes([0.2, 0.075, 0.25, 0.3],
    xlim=(xx1, xx2), ylim=(yy1, yy2))

axins1.plot(vx0_5, wobble_supremo[2][0], color = 'k', linestyle = 'dotted', marker = 's', fillstyle = 'none', markersize = 10, markevery = [26])
axins1.plot(vx1_5, wobble_supremo[2][1], color = 'k', linestyle = 'dotted', marker = 'o', fillstyle = 'none', markersize = 10, markevery = [30])
axins1.plot(vx2_5, wobble_supremo[2][2], color = 'k', linestyle = 'dotted', marker = '^', fillstyle = 'none', markersize = 10, markevery = [33])
...
xx1_2, xx2_2, yy1_2, yy2_2 = 68, 75, -22, -17
axins2 = ax3.inset_axes([0.45, 0.65, 0.25, 0.3],
    xlim=(xx1_2, xx2_2), ylim=(yy1_2, yy2_2))

axins2.plot(vx0_4, wobble_supremo[1][0], color = 'k', linestyle = 'dashed', marker = 's', fillstyle = 'none', markersize = 10, markevery = [65])
axins2.plot(vx1_4, wobble_supremo[1][1], color = 'k', linestyle = 'dashed', marker = 'o', fillstyle = 'none', markersize = 10, markevery = [70])
axins2.plot(vx2_4, wobble_supremo[1][2], color = 'k', linestyle = 'dashed', marker = '^', fillstyle = 'none', markersize = 10, markevery = [75])
axins2.fill_between(x_shadow, y_shadow, color='lightgray', alpha = 0.5)
axins2.hlines(0, 0, 105, colors='k', linestyles='solid')
axins2.grid()
ax3.indicate_inset_zoom(axins2, edgecolor="black")

plt.grid()
# plt.savefig('wobble-cl.pdf')
plt.show()
