...
% https://motorcyclesmarts.com/highside-crashes/
% High side pictures

% https://motorcyclesmarts.com/lowside-crashes/
% Low side pictures
...
\begin{figure}
    \begin{subfigure}[t]{.4\textwidth}
        \centering
        \includegraphics[width=\linewidth]{highside_1.png}
        \caption{First stage: vehicle turning to the right with both wheels following the desired path.}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{.4\textwidth}
        \centering
        \includegraphics[width=\linewidth]{highside_2.png}
        \caption{Second stage: the rear wheel loses grip and the vehicle turns more than rider input.}
    \end{subfigure}
    ...
    \begin{subfigure}[t]{.4\textwidth}
        \centering
        \includegraphics[width=\linewidth]{highside_3.png}
        \caption{Third stage: the rear wheel suddenly regains grip, creating large rotational acceleration that ejects the rider.}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{.4\textwidth}
        \centering
        \includegraphics[width=\linewidth]{highside_4.png}
        \caption{Fourth stage: the rider is disconnected from the vehicle and the control is completely lost.}
    \end{subfigure}
    \caption{High-side crash schematical sequence.}
    \label{fig: highside}
\end{figure}
