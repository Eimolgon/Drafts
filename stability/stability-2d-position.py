...
for ii in cop_pos:
    ...
    l_A = b + ii                #Posición longitudinal centro aerodinámico
    width = 0.1
    length = 0.2
    Num_wing = 4
    ...
    for i in Vx_rango:
        ...
        Normal_f.append(N_f)
        Normal_r.append(N_r)
        Normal_f2.append(N_f)
        Normal_r2.append(N_r)
    ...
    Super_normal_f.append(Normal_f2)
    Super_normal_r.append(Normal_r2)
...
ax.plot(Vx_rango[1:len(Vx_rango)-1], ss_wea[0][1:len(Vx_rango)-1], color = 'k', linestyle = 'dashed', label = 'CoP = Rear')
ax.plot(Vx_rango[1:len(Vx_rango)-1], ss_wea[1][1:len(Vx_rango)-1], color = 'k', linestyle = 'solid', label = 'CoP = CoM')
ax.plot(Vx_rango[1:len(Vx_rango)-1], ss_wea[2][1:len(Vx_rango)-1], color = 'k', linestyle = 'dashdot', label = 'CoP = Front')
...
xx1, xx2, yy1, yy2 = 73, 84, -0.25, 0.25
axins = ax.inset_axes([0.34, 0.42, 0.3, 0.2],
    xlim=(xx1, xx2), ylim=(yy1, yy2))

axins.plot(Vx_rango, ss_wea[0], color = 'k', linestyle = 'dashed', label = 'CoP = Rear')
axins.plot(Vx_rango, ss_wea[1], color = 'k', linestyle = 'solid', label = 'CoP = CoM')
axins.plot(Vx_rango, ss_wea[2], color = 'k', linestyle = 'dashdot', label = 'CoP = Front')
...
plt.plot(Vx_rango[1:len(Vx_rango)-1], ss_wob[0][1:len(Vx_rango)-1], color = 'k', linestyle = 'dashed', label = 'CoP = Rear')
plt.plot(Vx_rango[1:len(Vx_rango)-1], ss_wob[1][1:len(Vx_rango)-1], color = 'k', linestyle = 'solid', label = 'CoP = CoM')
plt.plot(Vx_rango[1:len(Vx_rango)-1], ss_wob[2][1:len(Vx_rango)-1], color = 'k', linestyle = 'dashdot', label = 'CoP = Front')
plt.text(21, -9, r'\textit{wobble}', size=15)
plt.text(70, -1, r'\textit{weave}', size=15)

legend_wobble = plt.legend(handles=[plt.Line2D([0], [0], color='k', linestyle='dashed'),
                                   plt.Line2D([0], [0], color='k', linestyle='solid'),
                                   plt.Line2D([0], [0], color='k', linestyle='dashdot')],
                           labels=['CoP = Rear', 'CoP = CoM', 'CoP = Front'],
...
# ax.plot(Vx_rango[1:len(Vx_rango)-1], ss_wea[0][1:len(Vx_rango)-1], 'r-', label = 'CoP = -0.6')
# ax.plot(Vx_rango[1:len(Vx_rango)-1], ss_wea[1][1:len(Vx_rango)-1], 'b-', label = 'CoP = 0')
# ax.plot(Vx_rango[1:len(Vx_rango)-1], ss_wea[2][1:len(Vx_rango)-1], 'g-', label = 'CoP = +0.6')
...
#                            labels=['CoP = Rear (-0.6)', 'CoP = Aligned with CoM (0)', 'CoP = Front (+0.6)'],
#                            loc='upper left', fontsize = 15)


# # plt.title('Weave stability with $C_l = 1.5$')
# plt.xlabel('Longitudinal speed [m/s]', fontsize=18)
# plt.ylabel('Real part [1/s]', fontsize=18)
# plt.xticks(fontsize=14)
# plt.yticks(fontsize=14)
...
# xx1, xx2, yy1, yy2 = 73, 84, -0.5, 0.5
# axins = ax.inset_axes([0.5, 0.0625, 0.45, 0.4],
#     xlim=(xx1, xx2), ylim=(yy1, yy2))

# axins.plot(Vx_rango, ss_wea[0], 'r-')
# axins.plot(Vx_rango, ss_wea[1], 'b-')
# axins.plot(Vx_rango, ss_wea[2], 'g-')
# axins.fill_between(x_shadow, y_shadow, color='lightgray', alpha = 0.5)
# axins.hlines(0, 0, 105, colors='k', linestyles='solid')
# axins.grid()
...
# plt.plot(Vx_rango[1:len(Vx_rango)-1], ss_wob[0][1:len(Vx_rango)-1], 'r', label = 'CoP = -0.6')
# plt.plot(Vx_rango[1:len(Vx_rango)-1], ss_wob[1][1:len(Vx_rango)-1], 'b', label = 'CoP = 0')
# plt.plot(Vx_rango[1:len(Vx_rango)-1], ss_wob[2][1:len(Vx_rango)-1], 'g', label = 'CoP = +0.6')
# plt.text(45, -7, 'Wobble', size=16, fontstyle='italic')
...
# plt.text(10, -9.5, 'Stable', size=18, fontweight='bold')
# plt.xlim(0, 105)
# plt.ylim(-13, 2)
# plt.grid()
# plt.show()
...
# plt.plot(Vx_rango, ss_wea[0], 'r--', label = 'CoP = -0.6')
# plt.plot(Vx_rango, ss_wea[1], 'b--', label = 'CoP = 0')
# plt.plot(Vx_rango, ss_wea[2], 'g--', label = 'CoP = +0.6')
# plt.text(60, -1.0, 'Weave', size=16, fontstyle='italic')
...
# plt.hlines(0, 0, 105, colors='k', linestyles='solid')
# plt.text(10, 0.5, 'Unstable', size=18, fontweight='bold')
# plt.text(10, -5.5, 'Stable', size=18, fontweight='bold')
# plt.xlim(0, 105)
# plt.ylim(-6, 1.3)
# plt.grid()
# # plt.show()
